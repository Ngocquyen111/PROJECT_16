"""
Django settings for milk_shop project.
...
SECRET_KEY = 'django-insecure-^@8lc4!vt)_bu@_x^nl1u8n9i#c9ze+wuflfq0slmf@bf4e^+p'
...
WSGI_APPLICATION = 'milk_shop.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'driver': 'ODBC Driver 17 for SQL Server',  # Đảm bảo cài đúng driver ODBC
